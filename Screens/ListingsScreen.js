...
const BottomDealerDetailScreen = () => {
  ...
  const fetchDealer = async () => {
    ...
    await ref.get().then((querySnapshot) => {
      querySnapshot.forEach((documentSnapshot) => {
        dealerArr.push(documentSnapshot.data());
      });
      setDealer(dealerArr);
    });
  };
        ...
        >
          ...
          <View style={{flexDirection: "column", justifyContent: "flex-end"}}>
            ...
            <View style={{flexDirection: "column"}}>
              <Text style={styles.h1}>HSKB Motors</Text>

              <Text style={styles.txt1}>03345621236</Text>
            </View>
          </View>
        </View>
...
export default BottomDealerDetailScreen;
